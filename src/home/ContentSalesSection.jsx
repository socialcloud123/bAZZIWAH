...
const ContentSalesSection = ({ image = '/SSD_Website 9.png' }) => {
  return (
    <section className="content-sales-section">      <div className="content-sales-inner">
        <div className="content-sales-text">
          <h2>Good Content =&nbsp;<span>Good Sales</span></h2>
          <p>SS Digital shall help you grow your business with digital marketing by creating a unique brand voice</p>
          <ul>
